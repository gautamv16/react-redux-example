      ...
      <div className={styles.home}>
        ...
        <div className={styles.masthead}>
          <div className="container">
            ...
            <p>
              <a className={styles.github} href="https://github.com/gautamv16/react-redux-example"
                 target="_blank">
                <i className="fa fa-github"/> View on Github
              </a>
            </p>
            <GithubButton user="gautamv16"
                          repo="react-redux-example"
                          type="star"
                          width={160}
                          height={30}
                          count large/>
            ...
            <p className={styles.humility}>
              Created and maintained by <a href="https://twitter.com/gautamv16" target="_blank">@gautamv16</a>.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <p>
            I am fresher to redux and react, but this experience is awesome with this app. I personally believe that this stack is the future of web development
            and will survive for several years. I'm building my new projects like this, and I recommend that you do, too. Happy learning guys!!
          </p>

          <p>Thanks for taking time to learn from this.</p>
