...
export default class WidgetForm extends Component {
  ...
  render() {
    const { editStop, fields: {id, color, score, owner}, formKey, handleSubmit, invalid,
    ...
    return (
      <tr className={submitting ? styles.saving : ''}>
        ...
        <td className={styles.sprocketsCol}>
          <input type="text" className="form-control" {...score}/>
          {score.error && score.touched && <div className="text-danger">{score.error}</div>}
        </td>
